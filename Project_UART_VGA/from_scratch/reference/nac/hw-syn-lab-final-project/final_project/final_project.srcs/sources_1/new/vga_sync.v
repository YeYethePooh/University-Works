...
module vga_sync(
	...
	localparam H_L_BORDER      =  0; // horizontal left border
	localparam H_R_BORDER      =  0; // horizontal right border
	localparam H_RETRACE       =  0; // horizontal retrace
...
module vga(
    ...
    // compute gradient
    reg state = 0;
	reg [11:0] top_color = 12'b111111111111;
